import { HStack,Text, Flex, useDisclosure,Heading,useBreakpointValue,Modal,ModalFooter,ModalHeader,ModalOverlay,ModalBody,ModalCloseButton ,ModalContent,Box, Divider, Button } from "@chakra-ui/react";
...
const FinalSelection = () => {
 ...
 axios.post(apiEndpointBooking,payload1,{headers})
 .then((res)=>{
  console.log(res)
  ...
  return (
    <>
      ...
      <HStack>
       ...
       <Button isLoading={loading} onClick={checkoutHandler} width={{base:'100%', md:"50%",sm:"10%"}} h={{base:"40px",sm:"70px"}} variant={useBreakpointValue({ base: "solid", sm: "outline" })} bg={{ base: "accent.500", sm: "white" }} color={{ base: "white", sm: "accent.500" }} colorScheme={useBreakpointValue({ base: "accent.500", sm: "white" })} mb={{base:"5",sm:"10"}}>Book Now</Button>
       </HStack>
       ...
       <Modal isOpen={isOpen} onClose={onClose}>
        ...
        <ModalContent>
          ...
          <ModalFooter>
            <Button color={'accent.500'} variant={'outline'} colorScheme='accent.500' mr={3} onClick={handlePostBooking} >
              Go To Home
            </Button>
          </ModalFooter>
        </ModalContent>

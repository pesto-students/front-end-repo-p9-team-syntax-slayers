    ...
    <>
      ...
      <Slide direction='bottom' in={isOpen} style={{ zIndex: 10 }}>
          <Box
            ...
            shadow='md'
          >
            <Text fontSize={13}>Step into a revolutionized salon experience crafted by our cutting-edge online platform. With an array of salons listed from across the city, we bring a seamless beauty service booking process right to your fingertips. Our platform&apos;s intuitive design and customer-focused approach promise to eliminate the uncertainty and waiting times traditionally associated with salon visits. Moreover, backed by reputable investors, we have secured a strong foothold in the beauty industry, a testament to our commitment to excellence and innovation.</Text>
            <Text fontSize={13} mt={3}>Our Founders : Chetan Rao, Sidhanth Kamble </Text> 
            </Box>
        </Slide>
    </>
  );
